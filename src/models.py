...
if __name__ == "__main__":
    ...
    print("1. Creating Scenario model:")
    scenario = Scenario(**scenario_data)
    print("   ✓ Scenario created")
    print(f"   ✓ Scenario length: {len(scenario.scenario)} characters")
    ...
    print("\n2. Creating Options model:")
    options = Options(**options_data)
    print(f"   ✓ Options created with {len(options.options)} choices")
